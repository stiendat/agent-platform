  ...
  },
  {
    ...
    roles: [
      ...
      },
      {
        ...
        description: 'View team dashboards and use ARIA performance insights for their team',
        permissions: [
      ...
      },
      {
        ...
        description: 'View all dashboards and workforce-level ARIA insights',
        permissions: [
          'performance.dashboard.read',
          'performance.dashboard.team.read',
      ...
      {
        slug: 'performance.hr',
        description: 'Full performance access including ARIA HR-sensitive fields',
        permissions: [
          'performance.dashboard.read',
          'performance.dashboard.team.read',
          'performance.dashboard.executive.read',
